        ...
        <>
            <div className="mainMedium-Container" style={{ backgroundColor: '#F1F5FE' }}>
                ...
                <div className="rowHow">
                    <div className="rowHItem">
                        <img src={im1} alt="iconNumbers1" />
                    </div>
                    <div className="rowHItem" style={{ padding: '0' }}>
                        <div className="rowLineItem"></div>
                    </div>
                    <div className="rowHItem">
                        <img src={im2} alt="iconNumbers1" />
                    </div>
                    <div className="rowHItem" style={{ padding: '0' }}>
                        <div className="rowLineItem"></div>
                    </div>
                    <div className="rowHItem">
                        <img src={im3} alt="iconNumbers1" />
                    </div>
                    <div className="rowHItem" style={{ padding: '0' }}>
                        <div className="rowLineItem"></div>
                    </div>
