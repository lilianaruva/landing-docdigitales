...
const CarouselS = () => {
    return (
        <>
            <Carousel autoPlay centerMode showArrows={false} showStatus={false} showIndicators={false} showThumbs={false} emulateTouch swipeable>
                <div key="slide1" style={{ padding: 20, margin: 20, height: '65vh', backgroundColor: '#F1F5FE', borderRadius: '20px', transform:'translate3d(0%, 0px, 0px) important!' }}>
                ...
                <div key="slide2" style={{ padding: 20, margin: 20, height: '65vh', backgroundColor: '#F1F5FE', borderRadius: '20px' }}>
                    <div className="CarouselContainer">
                ...
                <div key="slide3" style={{ padding: 20, margin: 20, height: '65vh', backgroundColor: '#F1F5FE', borderRadius: '20px' }}>
                    <div className="CarouselContainer">
                ...
                <div key="slide4" style={{ padding: 20, margin: 20, height: '65vh', backgroundColor: '#F1F5FE', borderRadius: '20px' }}>
                    <div className="CarouselContainer">
