...
const ServiceTest = () => {
	return (
		<>
			<div className="flex h-screen service-background-color whiteSpace" id="greenSpot" style={{ backgroundColor: '#F1F5FE' }}>
				<div className="m-auto" style={{ backgroundColor: '#F1F5FE' }}>
					...
					<Link to="/login">
						<div className="lg:text-[18px] pt-[34px] text-center" style={{ marginBottom: '10rem', backgroundColor: '#F1F5FE' }}>
